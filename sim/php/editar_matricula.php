<?php
$pdo = new PDO('mysql:host=localhost;dbname=escola_eetan;charset=utf8mb4', 'adm', '', [PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE matriculas SET nome = :nome, email = :email, contato = :contato, endereco = :endereco, responsavel = :responsavel, cpf = :cpf, rg = :rg, escola_origem = :escola_origem, ano = :ano, turno = :turno, curso = :curso, necessidades = :necessidades WHERE id = :id");
    $stmt->execute([
        ':id' => $id,
        ':nome' => $nome,
        ':email' => $email,
